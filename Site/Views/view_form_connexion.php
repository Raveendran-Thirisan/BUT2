...
<div class="formulaire"> 
    ...
    <form method="post" action='?controller=connexion&action=login' id="form">
      ...
      <input  type='text'  name='idf' placeholder="Entrez votre numéro étudiant" id="inpNumeroEtudiant"/>  <br>
      <input class="inpMdp" type='password' name = 'mdp' placeholder="Entrez votre mot de passe"> <br>
      ...
      <br><a href="?controller=accueil&action=home" class="seConnecter">Se connecter en tant qu'inviter</a></br>
